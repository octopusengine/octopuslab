# Forked from Adafruit 
# https://github.com/adafruit/micropython-adafruit-rgb-display/blob/master/rgb.py

# Changes: fill rectangle optimalization, since empty spi.write(b'') tooks like 2 sec
