...
Terminal.prototype.fixMobile = function(document) {
  ...
  textarea.setAttribute("id", "mobile_textaera");

  document.getElementsByTagName('body')[0].appendChild(textarea);

  Terminal._textarea = textarea;
  var inp = document.getElementById("mobile_textaera").value;
  ...
  setTimeout(function() {
	...
	var intervalID = setInterval(function() {		
		...
		if (inp != " ")
		{
		self.send(inp.slice(1));
		}

		document.getElementById("mobile_textaera").value = " ";
	}, 10);
...
Terminal.prototype.resize = function(x, y) {
  ...
  //console.log("rows:" + this.rows + "  colums:" + this.cols);
  //console.log(this.lines);
